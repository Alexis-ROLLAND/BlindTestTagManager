...
void    bttParser::processArgs(){
    ...
    if (this->count(this->getCmdArg(arg_id_t::EXTRA_TITLE))) this->extra_title_handler();
    ...
    /** Language management part */
    if (this->count(this->getCmdArg(arg_id_t::LANGUAGE))){
    ...
    /** ismovie management part */
    if (this->count(this->getCmdArg(arg_id_t::IS_MOVIE))){
    ...
    /** istvshow management part */
    if (this->count(this->getCmdArg(arg_id_t::IS_TVSHOW))){
    ...
    /** ismasterpiece management part */
    if (this->count(this->getCmdArg(arg_id_t::IS_MASTERPIECE))){
    ...
    /** issbig management part */
    if (this->count(this->getCmdArg(arg_id_t::IS_SBIG))){
    ...
    /** Extra-Date management part  */
    if (this->count(this->getCmdArg(arg_id_t::EXTRA_DATE))){
